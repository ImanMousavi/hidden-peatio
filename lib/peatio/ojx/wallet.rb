module Ojx
  class Wallet < Peatio::Wallet::Abstract
    ...
    def touch_options_gas_price(options, transaction)
      if transaction.options.fetch(:gas_price, nil).present?
    ...
    def create_eth_transaction!(transaction, options = {})
      ...
      options = touch_options_gas_price options, transaction
